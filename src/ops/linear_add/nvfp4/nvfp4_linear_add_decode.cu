...
void nvfp4_linear_add_decode_launch(const Tensor& x, const Weight& weight, Tensor& residual,
    ...
    case Nvfp4Problem::Residual6144:
        launch<Nvfp4Residual6144Geometry>(x, weight, residual, projection, scores, stream);
        return;
    case Nvfp4Problem::Residual17408:
        launch<Nvfp4Residual17408Geometry>(x, weight, residual, projection, scores, stream);
        return;
